function [exGridE1,exGridE2,numIt,errorCode]=SteadyState_2D_SOR_Solver_2018_CORE...
...
while isNotConverged
   ...
   exGridE1(end,2:end-1)=0; %zero concentration at bottom boundary
   % exGridE1(end,2:end-1)=exGridE1(end-2,2:end-1); %zero flux at bottom boundary
    ...
    exGridE2(end,2:end-1)=0; %zero concentration at bottom boundary
    %exGridE2(end,2:end-1)=exGridE2(end-2,2:end-1); %zero concentration at bottom boundary
