...
%model is run on a fully closed chamber (no loss of amino acids)
%
...
for rr = 1:numRange
    ...
    parfor pp = 1:numPos
        ...
        [output,~,~,~] = SteadyState_2D_RefineGrid_ClosedBoundary(locSet2,initialCondition);
...
%%
save('dataFig5d.mat','rangeVec','muRealRel_mean','muRealDTRel_mean','muRealDPRel_mean', 'settings');