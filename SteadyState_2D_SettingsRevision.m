function settings=SteadyState_2D_SettingsRevision
% Default model and solver settings for 2D steady state model of amino acid exchange
...
fprintf('September 2019 Revision settings\n...last update %s\n',lastUpdate);
...
settings.randNumFeedDivision    = 428;
...
%% SET properties Division process
settings.targetLength           =2;
settings.bias                   =0; %bias in direction of cell movement:
